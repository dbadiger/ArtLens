  ...
  return (
    <div
      ...
      <form className="relative bg-white p-10 rounded-xl text-slate-500">
        ...
        <p className="text-sm text-center">Welcome! Please Signin to continue</p>
        ...
        {state === 'Login' ?
          ...
          :
          <p className='mt-5 text-center'>Already Have an Account? <span className='text-blue-600 cursor-pointer'onClick={()=>setState('Login')}>Login In</span></p>
        }

        <img className='absolute top-5 right-5 cursor-pointer' src={assets.cross_icon}
