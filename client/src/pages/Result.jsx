...
const Result = () => {
  ...
  const [image, setImage] = useState(assets.bmw)
  ...
  return (
    ...
    {!isImageLoaded && 
      ...
      placeholder='Describe what you want to geenrate' />
      <button type='submit'
    ...
    {isImageLoaded && 
      ...
      <div className="flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full">
        <p className='bg-transparant border border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer'
